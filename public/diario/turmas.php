    ...
    ?>
        <div class="turma-card">
            <div>
                ...
                <!-- Ações da Turma (Sincronização e Excel) -->
                <div style="display: flex; gap: 0.5rem; margin-top: 1rem; padding-top: 0.75rem; border-top: 1px solid var(--border); flex-wrap: wrap;">
                    <a href="/diario/turma?turma_id=<?= $tId ?>" style="flex: 1; min-width: 110px; text-align: center; display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; background: var(--bg); color: var(--dark); border: 1px solid var(--border); font-size: 0.75rem; font-weight: 700; padding: 0.45rem 0.65rem; border-radius: 6px; text-decoration: none;">
